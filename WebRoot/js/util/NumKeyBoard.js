...
(function($){
    $.fn.numkeyboard = function(options){
        ...
        this.each(function(){
            ...
            //元素css样式控制
            keyboard.css({"position":"absolute","z-index":"10000","display":"none","background":options.mainbackground,overflow:"hidden",
                "width":keyboardRadix*0.8,"height":keyboardRadix*0.5,"border-radius":keyboardRadix*0.01});
            ...
            keyboard_buttonul.css({position:"relative",margin:"auto","margin-top":keyboardRadix*0.03+"px",width:keyboardRadix*0.74,height:keyboardRadix*0.37});
