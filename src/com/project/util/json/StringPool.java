...
public class StringPool {
	...
	public static Map getSecurityResourceType() {
		if (SECURITY_RESOURCE_TYPE.isEmpty()) {
			...
			SECURITY_RESOURCE_TYPE
					.put(SECURITY_RESOURCE_TYPE_COMPONENTS, "???"); //此出源代码也是乱码，不知是什么
	...
	public static final String USER_RESORUCE_CATEGORY_ROOT_NAME="根分类";
	
	/**
	 * portal
	 */
	public static final String PORTAL_DEFAULT_PORTAL_NAME="首页";
	public static final String PORTAL_DEFAULT_USER_DEFINE_PORTAL_NAME="新建标签页";
	 ...
	 * Blog常量
	 */
	public static final String BLOG_ARTICLE_DEFAULT_USER_CATEGORY_NAME="默认分类";
