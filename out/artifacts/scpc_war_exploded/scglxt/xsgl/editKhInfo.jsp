        ...
        <div class="box">
            ...
            <div class="box-content box-no-padding">
                <form id="form_khxx" class='form form-horizontal ' method="post" style='margin-bottom: 0;'>
                    ...
                    <div class='form-group'>
                        <label class='control-label col-sm-3' for='form_khxx_lxr'>联系人</label>

                        <div class='col-sm-4 controls'>
                            <input class='form-control' id='form_khxx_lxr' name='form_khxx_lxr' placeholder='联系人'
                                   type='text'>
                        </div>
                    </div>
                    <div class='form-group'>
                        <label class='control-label col-sm-3' for='form_khxx_lxdh'>联系电话</label>

                        <div class='col-sm-4 controls'>
                            <input class='form-control' id='form_khxx_lxdh' name='form_khxx_lxdh' placeholder='联系电话'
                                   type='text'>
                        </div>
                    </div>
                    <div class='form-group'>
